...
then
    echo "The Valheim server is not set to public.  It will not show up in the server list.  Players must join via IP address instead"
else
    echo "The Valheim server is set to public visibility.  It will be visible in the server list.  Players will still need to enter the password to join"
fi
